...
-   **Explore First:** Check the [Issues](https://github.com/GraphLens/graphlens/issues) to avoid duplicates and review the [Current limitations](https://github.com/GraphLens/graphlens?tab=readme-ov-file#4-current-limitations) section in the README.
...
[Rate GraphLens on VS Code Marketplace](https://marketplace.visualstudio.com/items?itemName=GraphLens.graphlens&ssr=false#review-details)
